...
const TechInnovation = () => {
  ...
  return (
    <section className="w-full bg-white flex flex-col items-center pt-16 lg:pt-24 pb-12 lg:pb-24 overflow-hidden relative">
      ...
      >
        <h2 className="text-[26px] sm:text-3xl lg:text-4xl font-medium tracking-tight text-gray-900">
          Technological Innovation
        </h2>
        <p className="text-gray-500 font-light text-[14px] sm:text-[15px] leading-relaxed max-w-[800px]">
