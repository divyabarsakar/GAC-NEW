  ...
  return (
    <section className="bg-white py-16 md:py-20 w-full overflow-hidden relative border-t border-gray-100">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Left Side: Content */}
        <div className="flex flex-row items-start gap-6 md:w-[45%] mb-12 md:mb-0 ml-0 md:ml-12 pt-8">
          ...
          <div className="flex flex-col mt-0 md:mt-1">
            <h2 className="text-3xl md:text-[2.2rem] font-medium text-gray-900 leading-tight tracking-normal mb-2 md:mb-3">
              GAC APP
            </h2>
            <p className="text-[#999999] text-sm md:text-sm max-w-md tracking-wide font-light leading-relaxed">
        ...
        <div className="md:w-[55%] flex justify-end relative">
          <img 
             ...
             alt="GAC App mockups" 
             className="w-full max-w-[650px] object-contain object-right" 
          />
        </div>
